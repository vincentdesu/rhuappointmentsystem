...
$services = $admin_functions->show_scheds();
$admin_functions->sched_edit();
$admin_functions->sched_delete();
$admin_functions->sched_add();
    ...
    <div class="container-fluid">
        ...
        <div class="bg-dark text-white p-3" style="width: 250px; height: 100vh;">
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a href="ad sched.php" class="nav-link text-white active bg-primary">Schedules</a></li>
            ...
            <main class="col-md-10 p-4">
                                ...
                                <?php foreach ($services as $service) { ?>
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" name="services[]" value="<?= $service['services']; ?>" class="form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="sched[]" value="<?= $service['sched']; ?>" class="form-control">
                                        </td>
                                        <td>
                ...
                <form action="" method="POST" class="row g-3">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="new_sched" placeholder="Schedule Available" required class="form-control">
                    </div>
                    <div class="col-12">
